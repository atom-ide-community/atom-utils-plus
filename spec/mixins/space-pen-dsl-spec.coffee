...
describe 'space-pen DSL', ->
  ...
  describe 'when the content method is available on the element class', ->
    beforeEach ->
      BabelDummyElement = require '../fixtures/babel-element'
      BabelDummyElement = registerOrUpdateElement 'dummy-babel-element-dsl', class: BabelDummyElement

      element = new BabelDummyElement
